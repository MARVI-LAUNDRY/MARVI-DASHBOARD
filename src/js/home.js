const demo = () => {
    ...
    const primaryColor = "#dd5746";
    const secondaryColor = "#ffe1c09f";

    // Gráfico de Área
    const areaCtx = document.getElementById("areaChart").getContext("2d");
    // Crear el degradado
    const gradientColor = areaCtx.createLinearGradient(0, 0, 0, 400);
    gradientColor.addColorStop(0, secondaryColor);
    gradientColor.addColorStop(1, secondaryColor);
    const areaData = {
